...
/* harmony default export */ __webpack_exports__["default"] = (Ractive.extend({
    ...
    onrender: function(){
        ...
        this.observe_basedon = this.observe('basedon', function(newValue, oldValue, keypath){
            ...
            if(newValue === true){
                if(document.querySelector('.'+popup_id) && document.querySelector('.'+popup_id).style.display === 'flex'){
                    return;
                }
                ...
                this.set({'display': 'flex', 'zindex': zindex});
