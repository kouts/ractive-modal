...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_ractive__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_ractive___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_ractive__);



__WEBPACK_IMPORTED_MODULE_0_ractive___default.a.sharedSet({'rm.animating': undefined, 'rm.delay': 0});
/* harmony default export */ __webpack_exports__["default"] = (__WEBPACK_IMPORTED_MODULE_0_ractive___default.a.extend({
                    ...
                    if(lastZindex > 0){
                        ...
                        for (var i = 0; i < all.length; i++) {
                            if(all[i].style.zIndex == lastZindex){
                                var r = __WEBPACK_IMPORTED_MODULE_0_ractive___default.a.getContext(all[i]).ractive;
